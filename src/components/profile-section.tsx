  ...
  return (
    <div className="md:sticky top-12 flex flex-row-reverse md:flex-col gap-4 md:space-y-8">
      ...
      <div className="w-2/3 md:w-full">
        ...
        <p className="text-zinc-600 text-xs leading-relaxed tracking-wide uppercase mb-6 -ml-px">
          {aboutMe.title}
          <br />
        ...
        <div className="space-y-2">
          ...
          {aboutMe.blueskyUsername && (
            <>
              <br />
              <a
                href={`https://bsky.app/profile/${aboutMe.blueskyUsername}`}
                className="inline-flex items-center gap-2 text-sm text-zinc-600 hover:text-zinc-900 transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Globe size={14} />@{aboutMe.blueskyUsername}
              </a>
            </>
          )}
